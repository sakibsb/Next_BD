            ...
            <div className='flex items-center gap-4 md:gap-6 overflow-x-scroll scrollbar-none transition-all' ref={scrollElement}>
                ...
                {loading ? (
                    loadingList.map((_, index) => (
                        <div key={index} className='w-full min-w-[120px] md:min-w-[220px] max-w-[120px] md:max-w-[220px] bg-white rounded-md shadow-lg'>
                            ...
                            <div className='p-4 grid gap-2'>
                                ...
                                <div className='flex gap-3'>
                                    <p className='text-green-600 font-medium p-1 animate-pulse bg-slate-200 rounded-full w-full py-2'></p>
                    ...
                    data.map((product) => (
                        <Link to={`/product/${product?._id}`} key={product?._id} className='w-full min-w-[120px] md:min-w-[220px] max-w-[120px] md:max-w-[220px] bg-white rounded-md shadow-lg'>
                            ...
                            <div className='p-4 grid gap-2'>
                                ...
                                <div className='flex justify-center items-center p-4'>
                                    <button className='w-32 h-10 items-center justify-center text-sm bg-gradient-to-r from-blue-500 to-teal-500 hover:from-blue-600 hover:to-teal-600 text-white rounded-full transition-colors duration-300' onClick={(e) => handleAddToCart(e, product?._id)}>
                                        Add to Cart
                                    </button>
                                </div>
                            </div>
