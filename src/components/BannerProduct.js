            ...
            <div className='h-56 md:h-72 w-full bg-slate-200 relative'>
                <div className='absolute z-10 h-full w-full md:flex items-center hidden'>
                    <div className='flex justify-between w-full text-3xl'>
                        <button className='bg-white shadow-md rounded-full p-1' onClick={preveImage}><FaAnglesLeft /></button>
                        <button className='bg-white shadow-md rounded-full p-1' onClick={nextImage}> <FaAnglesRight /></button>
                    </div>
                </div>
